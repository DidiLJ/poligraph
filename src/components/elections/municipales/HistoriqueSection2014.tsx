...
import type { Historique2014 } from "@/lib/data/municipales";

interface HistoriqueSection2014Props {
  data: Historique2014;
}
...
export function HistoriqueSection2014({ data }: HistoriqueSection2014Props) {
  return (
    <Card className="bg-muted/30">
      <CardContent className="pt-6">
        <h3 className="text-lg font-semibold mb-4">En 2014</h3>
