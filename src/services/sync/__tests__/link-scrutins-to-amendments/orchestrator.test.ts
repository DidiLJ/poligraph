...
let linkScrutinsToAmendments: typeof import("@/services/sync/link-scrutins-to-amendments").linkScrutinsToAmendments;
...
describeIfDb("linkScrutinsToAmendments (orchestrator)", () => {
  beforeAll(async () => {
    ({ db } = await import("@/lib/db"));
    ({ linkScrutinsToAmendments } = await import("@/services/sync/link-scrutins-to-amendments"));
